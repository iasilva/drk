...
class View {
    ...
    /**
     * Prepara a string da template a ser retornada - Ivan
     * @param string $Template
     */
    public static function loadString($Template) {
        self::$Template = (string) $Template;
    }

    public static function getString(array $Data) {
        self::setKeys($Data);
        self::setValues();
        self::getView();
    ...
    public static function getView() {
         str_replace(self::$Keys, self::$Values, self::$Template);
    ...
    private static function ShowView() {
        $str_replace = str_replace(self::$Keys, self::$Values, self::$Template);
        echo $str_replace;
    }
